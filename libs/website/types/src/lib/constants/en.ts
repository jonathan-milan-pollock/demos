...
export const enTranslation: Translation = {
  ...
  aboutOpenHours: 'Open Monday through Sunday 24 hours',
  aboutPhotographyLocationsTitle: 'PHOTOGRAPHY LOCATIONS',
  aboutPhotographyLocations:
  ...
  aboutBuckheadGeorgia: 'Buckhead, Georgia',
  aboutMidtownGeorgia: 'Midtown, Georgia',
  aboutSandySpringsGeorgia: 'Sandy Springs, Georgia',
  aboutDunwoodyGeoriga: 'Dunwoody, Georgia',
  aboutViningsGeorgia: 'Vinings, Georgia',
  aboutAtlantaGeorgia: 'Atlanta, Georgia',
};
