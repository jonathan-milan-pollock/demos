import { PageType, Metadata } from '@dark-rush-photography/website/types';
...
export const getMetadata = (pageType: PageType, url: string): Metadata | undefined => {
