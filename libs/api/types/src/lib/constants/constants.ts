...
export const IMAGE_VIDEO_LOGO_FRAME_PNG = 'image-video-logo-frame.png';
export const IMAGE_VIDEO_MIME_TYPE = 'video/mp4';
export const IS_PUBLIC = 'isPublic';
export const JWT = 'jwt';
export const MELT_COMMAND_DEV = '/Applications/Shotcut.app/Contents/MacOS/melt';
export const MELT_COMMAND_PROD = 'xvfb-run -a /opt/Shotcut/Shotcut.app/melt';
...
export const YOUTUBE_VIDEO_PLAYLIST_ID = 'UCYnbcE9nrZv7rBuAF7tLFdw';
