...
export * from './lib/interfaces/dimension.interface';
export * from './lib/interfaces/entity-admin.interface';
export * from './lib/interfaces/entity-find-all-public-response.interface';
export * from './lib/interfaces/entity-find-one-public-response.interface';
export * from './lib/interfaces/entity-id-order.interface';
...
export * from './lib/interfaces/exif-created-date.interface';
...
export * from './lib/interfaces/image-file-path-emotion.interface';
export * from './lib/interfaces/image-id-order.interface';
...
export * from './lib/interfaces/json-ld-news-article.interface';
