...
module.exports = df.orchestrator(function* (context) {
  ...
  const logContext = 'MediaProcessOrchestrator';

  context.log(`[${logContext}] Media Process orchestrator started`);
  ...
  context.log(
    `[${logContext}] Media Process orchestrator completed ${completedProcesses.join(
      ', '
    )}`
  );
